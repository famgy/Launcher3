...
//            return  cl.getLocalContentProvider();
//        }

        try {
            return (LauncherProvider)context.getContentResolver()
                    .acquireContentProviderClient(LauncherProvider.AUTHORITY).getLocalContentProvider();
        } catch (Exception e) {
            e.printStackTrace();
        }
